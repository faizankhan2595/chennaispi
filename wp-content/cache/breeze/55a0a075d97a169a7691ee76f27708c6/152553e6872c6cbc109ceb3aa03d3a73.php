a:2:{s:4:"body";s:115760:"<!DOCTYPE html>
<html lang="en-US"
...
<head><script>if(navigator.userAgent.match(/MSIE|Internet Explorer/i)||navigator.userAgent.match(/Trident\/7\..*?rv:11/i)){var href=document.location.href;if(!href.match(/[?&]nowprocket/)){if(href.indexOf("?")==-1){if(href.indexOf("#")==-1){document.location.href=href+"?nowprocket=1"}else{document.location.href=href.replace("#","?nowprocket=1#")}}else{if(href.indexOf("#")==-1){document.location.href=href+"&nowprocket=1"}else{document.location.href=href.replace("#","&nowprocket=1#")}}}}</script><script>class RocketLazyLoadScripts{constructor(e){this.triggerEvents=e,this.eventOptions={passive:!0},this.userEventListener=this.triggerListener.bind(this),this.delayedScripts={normal:[],async:[],defer:[]},this.allJQueries=[]}_addUserInteractionListener(e){this.triggerEvents.forEach((t=>window.addEventListener(t,e.userEventListener,e.eventOptions)))}_removeUserInteractionListener(e){this.triggerEvents.forEach((t=>window.removeEventListener(t,e.userEventListener,e.eventOptions)))}triggerListener(){this._removeUserInteractionListener(this),"loading"===document.readyState?document.addEventListener("DOMContentLoaded",this._loadEverythingNow.bind(this)):this._loadEverythingNow()}async _loadEverythingNow(){this._delayEventListeners(),this._delayJQueryReady(this),this._handleDocumentWrite(),this._registerAllDelayedScripts(),this._preloadAllScripts(),await this._loadScriptsFromList(this.delayedScripts.normal),await this._loadScriptsFromList(this.delayedScripts.defer),await this._loadScriptsFromList(this.delayedScripts.async),await this._triggerDOMContentLoaded(),await this._triggerWindowLoad(),window.dispatchEvent(new Event("rocket-allScriptsLoaded"))}_registerAllDelayedScripts(){document.querySelectorAll("script[type=rocketlazyloadscript]").forEach((e=>{e.hasAttribute("src")?e.hasAttribute("async")&&!1!==e.async?this.delayedScripts.async.push(e):e.hasAttribute("defer")&&!1!==e.defer||"module"===e.getAttribute("data-rocket-type")?this.delayedScripts.defer.push(e):this.delayedScripts.normal.push(e):this.delayedScripts.normal.push(e)}))}async _transformScript(e){return await this._requestAnimFrame(),new Promise((t=>{const n=document.createElement("script");let i;[...e.attributes].forEach((e=>{let t=e.nodeName;"type"!==t&&("data-rocket-type"===t&&(t="type",i=e.nodeValue),n.setAttribute(t,e.nodeValue))})),e.hasAttribute("src")&&this._isValidScriptType(i)?(n.addEventListener("load",t),n.addEventListener("error",t)):(n.text=e.text,t()),e.parentNode.replaceChild(n,e)}))}_isValidScriptType(e){return!e||""===e||"string"==typeof e&&["text/javascript","text/x-javascript","text/ecmascript","text/jscript","application/javascript","application/x-javascript","application/ecmascript","application/jscript","module"].includes(e.toLowerCase())}async _loadScriptsFromList(e){const t=e.shift();return t?(await this._transformScript(t),this._loadScriptsFromList(e)):Promise.resolve()}_preloadAllScripts(){var e=document.createDocumentFragment();[...this.delayedScripts.normal,...this.delayedScripts.defer,...this.delayedScripts.async].forEach((t=>{const n=t.getAttribute("src");if(n){const t=document.createElement("link");t.href=n,t.rel="preload",t.as="script",e.appendChild(t)}})),document.head.appendChild(e)}_delayEventListeners(){let e={};function t(t,n){!function(t){function n(n){return e[t].eventsToRewrite.indexOf(n)>=0?"rocket-"+n:n}e[t]||(e[t]={originalFunctions:{add:t.addEventListener,remove:t.removeEventListener},eventsToRewrite:[]},t.addEventListener=function(){arguments[0]=n(arguments[0]),e[t].originalFunctions.add.apply(t,arguments)},t.removeEventListener=function(){arguments[0]=n(arguments[0]),e[t].originalFunctions.remove.apply(t,arguments)})}(t),e[t].eventsToRewrite.push(n)}function n(e,t){const n=e[t];Object.defineProperty(e,t,{get:n||function(){},set:n=>{e["rocket"+t]=n}})}t(document,"DOMContentLoaded"),t(window,"DOMContentLoaded"),t(window,"load"),t(window,"pageshow"),t(document,"readystatechange"),n(document,"onreadystatechange"),n(window,"onload"),n(window,"onpageshow")}_delayJQueryReady(e){let t=window.jQuery;Object.defineProperty(window,"jQuery",{get:()=>t,set(n){if(n&&n.fn&&!e.allJQueries.includes(n)){n.fn.ready=n.fn.init.prototype.ready=function(t){e.domReadyFired?t.bind(document)(n):document.addEventListener("rocket-DOMContentLoaded",(()=>t.bind(document)(n)))};const t=n.fn.on;n.fn.on=n.fn.init.prototype.on=function(){if(this[0]===window){function e(e){return e.split(" ").map((e=>"load"===e||0===e.indexOf("load.")?"rocket-jquery-load":e)).join(" ")}"string"==typeof arguments[0]||arguments[0]instanceof String?arguments[0]=e(arguments[0]):"object"==typeof arguments[0]&&Object.keys(arguments[0]).forEach((t=>{delete Object.assign(arguments[0],{[e(t)]:arguments[0][t]})[t]}))}return t.apply(this,arguments),this},e.allJQueries.push(n)}t=n}})}async _triggerDOMContentLoaded(){this.domReadyFired=!0,await this._requestAnimFrame(),document.dispatchEvent(new Event("rocket-DOMContentLoaded")),await this._requestAnimFrame(),window.dispatchEvent(new Event("rocket-DOMContentLoaded")),await this._requestAnimFrame(),document.dispatchEvent(new Event("rocket-readystatechange")),await this._requestAnimFrame(),document.rocketonreadystatechange&&document.rocketonreadystatechange()}async _triggerWindowLoad(){await this._requestAnimFrame(),window.dispatchEvent(new Event("rocket-load")),await this._requestAnimFrame(),window.rocketonload&&window.rocketonload(),await this._requestAnimFrame(),this.allJQueries.forEach((e=>e(window).trigger("rocket-jquery-load"))),window.dispatchEvent(new Event("rocket-pageshow")),await this._requestAnimFrame(),window.rocketonpageshow&&window.rocketonpageshow()}_handleDocumentWrite(){const e=new Map;document.write=document.writeln=function(t){const n=document.currentScript,i=document.createRange(),r=n.parentElement;let a=e.get(n);void 0===a&&(a=n.nextSibling,e.set(n,a));const o=document.createDocumentFragment();i.setStart(o,0),o.appendChild(i.createContextualFragment(t)),r.insertBefore(o,a)}}async _requestAnimFrame(){return new Promise((e=>requestAnimationFrame(e)))}static run(){const e=new RocketLazyLoadScripts(["keydown","mousemove","touchmove","touchstart","touchend","touchcancel","touchforcechange","wheel"]);e._addUserInteractionListener(e)}}RocketLazyLoadScripts.run();
    ...
    <title>Osteoporosis Spine Fracture Surgery Treatment in Chennai, India</title><link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto%3Aregular%2C400%2C700%2C900%7CExo%3A700%2C400%2C900%7CRoboto%3A400%2C500%2C700%7CExo%3A300%2C300i%2C400%2C700%2C700i%2C900%7CExo%3A100%2C100italic%2C200%2C200italic%2C300%2C300italic%2C400%2C400italic%2C500%2C500italic%2C600%2C600italic%2C700%2C700italic%2C800%2C800italic%2C900%2C900italic%7CRoboto%3A100%2C100italic%2C200%2C200italic%2C300%2C300italic%2C400%2C400italic%2C500%2C500italic%2C600%2C600italic%2C700%2C700italic%2C800%2C800italic%2C900%2C900italic&#038;display=swap" /><link rel="stylesheet" href="https://www.chennaispinecare.com/wp-content/cache/min/1/e8dae14ecfd447b5aa0c8d625349301b.css" media="all" data-minify="1" />

		<!-- All in One SEO 4.1.3.3 -->
		<meta name="description" content="Dr. Vignesh Pushparaj is a most-trusted Spine Fracture Surgeon in Chennai, India provides affordable Osteoporosis Spine Fracture Surgery Treatment. Call Us- 9150955655"/>
		<link rel="canonical" href="https://www.chennaispinecare.com/service/osteoporotic-spine-fracture-management/" />
		<meta property="og:site_name" content="Chennai Spine Care - Chennai Spine Care" />
		<meta property="og:type" content="article" />
		<meta property="og:title" content="Osteoporosis Spine Fracture Surgery Treatment in Chennai, India" />
		<meta property="og:description" content="Dr. Vignesh Pushparaj is a most-trusted Spine Fracture Surgeon in Chennai, India provides affordable Osteoporosis Spine Fracture Surgery Treatment. Call Us- 9150955655" />
		<meta property="og:url" content="https://www.chennaispinecare.com/service/osteoporotic-spine-fracture-management/" />
		<meta property="article:published_time" content="2021-07-10T15:18:09Z" />
		<meta property="article:modified_time" content="2021-09-10T07:28:46Z" />
		<meta name="twitter:card" content="summary" />
		<meta name="twitter:domain" content="www.chennaispinecare.com" />
		<meta name="twitter:title" content="Osteoporosis Spine Fracture Surgery Treatment in Chennai, India" />
		<meta name="twitter:description" content="Dr. Vignesh Pushparaj is a most-trusted Spine Fracture Surgeon in Chennai, India provides affordable Osteoporosis Spine Fracture Surgery Treatment. Call Us- 9150955655" />
		<script type="application/ld+json" class="aioseo-schema">
			{"@context":"https:\/\/schema.org","@graph":[{"@type":"WebSite","@id":"https:\/\/www.chennaispinecare.com\/#website","url":"https:\/\/www.chennaispinecare.com\/","name":"Chennai Spine Care","description":"Chennai Spine Care","publisher":{"@id":"https:\/\/www.chennaispinecare.com\/#organization"}},{"@type":"Organization","@id":"https:\/\/www.chennaispinecare.com\/#organization","name":"Chennai Spine Care","url":"https:\/\/www.chennaispinecare.com\/","logo":{"@type":"ImageObject","@id":"https:\/\/www.chennaispinecare.com\/#organizationLogo","url":"https:\/\/www.chennaispinecare.com\/wp-content\/uploads\/2021\/07\/annamalai-logo.png","width":"250","height":"150"},"image":{"@id":"https:\/\/www.chennaispinecare.com\/#organizationLogo"},"contactPoint":{"@type":"ContactPoint","telephone":"+919150955655","contactType":"Customer Support"}},{"@type":"BreadcrumbList","@id":"https:\/\/www.chennaispinecare.com\/service\/osteoporotic-spine-fracture-management\/#breadcrumblist","itemListElement":[{"@type":"ListItem","@id":"https:\/\/www.chennaispinecare.com\/#listItem","position":"1","item":{"@type":"WebPage","@id":"https:\/\/www.chennaispinecare.com\/","name":"Home","description":"Dr Vignesh Pushparaj is one of the Best Consultant Orthopaedic Spine Surgeons & Neuro Specialist Doctor at Annaamalai Ortho in Chennai. He is an Expert in Key Hole Spine Fracture Surgery, Scoliosis Correction, Spine Tumour.","url":"https:\/\/www.chennaispinecare.com\/"},"nextItem":"https:\/\/www.chennaispinecare.com\/service\/osteoporotic-spine-fracture-management\/#listItem"},{"@type":"ListItem","@id":"https:\/\/www.chennaispinecare.com\/service\/osteoporotic-spine-fracture-management\/#listItem","position":"2","item":{"@type":"WebPage","@id":"https:\/\/www.chennaispinecare.com\/service\/osteoporotic-spine-fracture-management\/","name":"Osteoporotic Spine Fracture Management:","description":"Dr. Vignesh Pushparaj is a most-trusted Spine Fracture Surgeon in Chennai, India provides affordable Osteoporosis Spine Fracture Surgery Treatment. Call Us- 9150955655","url":"https:\/\/www.chennaispinecare.com\/service\/osteoporotic-spine-fracture-management\/"},"previousItem":"https:\/\/www.chennaispinecare.com\/#listItem"}]},{"@type":"Person","@id":"https:\/\/www.chennaispinecare.com\/author\/admin\/#author","url":"https:\/\/www.chennaispinecare.com\/author\/admin\/","name":"Vignesh Pushparaj","image":{"@type":"ImageObject","@id":"https:\/\/www.chennaispinecare.com\/service\/osteoporotic-spine-fracture-management\/#authorImage","url":"https:\/\/secure.gravatar.com\/avatar\/82ee7eff6d6757a3d9aed65bf358048c?s=96&d=mm&r=g","width":"96","height":"96","caption":"Vignesh Pushparaj"}},{"@type":"WebPage","@id":"https:\/\/www.chennaispinecare.com\/service\/osteoporotic-spine-fracture-management\/#webpage","url":"https:\/\/www.chennaispinecare.com\/service\/osteoporotic-spine-fracture-management\/","name":"Osteoporosis Spine Fracture Surgery Treatment in Chennai, India","description":"Dr. Vignesh Pushparaj is a most-trusted Spine Fracture Surgeon in Chennai, India provides affordable Osteoporosis Spine Fracture Surgery Treatment. Call Us- 9150955655","inLanguage":"en-US","isPartOf":{"@id":"https:\/\/www.chennaispinecare.com\/#website"},"breadcrumb":{"@id":"https:\/\/www.chennaispinecare.com\/service\/osteoporotic-spine-fracture-management\/#breadcrumblist"},"author":"https:\/\/www.chennaispinecare.com\/author\/admin\/#author","creator":"https:\/\/www.chennaispinecare.com\/author\/admin\/#author","datePublished":"2021-07-10T15:18:09+00:00","dateModified":"2021-09-10T07:28:46+00:00"}]}
		</script>
		<!-- All in One SEO -->
...
<link rel='shortlink' href='https://www.chennaispinecare.com/?p=6135' />
...
<div id="post-6135" class="page-contents post-6135 medizco-service type-medizco-service status-publish hentry" role="main">
  <div class="builder-content">
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
			            <ul class="medizco_servics_list">
                                        <li>
                            <a href="https://www.chennaispinecare.com/service/back-and-neck-pain-management/" class="">
                            ...
                            <a href="https://www.chennaispinecare.com/service/injection-procedures-in-spine/" class="">
                                ...
                                <i class="fa fa-chevron-right"></i>
                                            ...
                                            <li>
                            <a href="https://www.chennaispinecare.com/service/osteoporotic-spine-fracture-management/" class="active">
				...
				<div class="elementor-element elementor-element-5a94dace doctor_schedule_box elementor-widget elementor-widget-elementskit-image-box" data-id="5a94dace" data-element_type="widget" data-widget_type="elementskit-image-box.default">
				<div class="elementor-widget-container">
            ...
            <div class="elementskit-info-image-box ekit-image-box text-center floating-style" >
                ...
                <div class="elementskit-box-body ekit-image-box-body">
                    <div class="elementskit-box-content ekit-image-box-body-inner">
                            ...
                            <i aria-hidden="true" class="fasicon icon-calendar"></i>
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
			<h2 class="elementor-heading-title elementor-size-default">Osteoporotic Spine Fracture Management</h2>		</div>
				</div>
				...
				<div class="elementor-widget-container">
								<div class="elementor-text-editor elementor-clearfix">
				<p>Osteoporosis is a disease of progressive bone loss associated with an increased risk of fractures. Osteoporosis causes loss of height and rounded upper back.</p>					</div>
						</div>
				</div>
            ...
            <div class="elementskit-info-image-box ekit-image-box text-center simple-card" >
                ...
                <div class="elementskit-box-header image-box-img-center">
                    ...
                    <img width="361" height="224" src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20361%20224'%3E%3C/svg%3E" class="attachment-medium_large size-medium_large" alt="Osteoporotic Spine Fracture surgery" data-lazy-srcset="https://www.chennaispinecare.com/wp-content/uploads/2021/07/orthos.png 361w, https://www.chennaispinecare.com/wp-content/uploads/2021/07/orthos-300x186.png 300w" data-lazy-sizes="(max-width: 361px) 100vw, 361px" data-lazy-src="https://www.chennaispinecare.com/wp-content/uploads/2021/07/orthos.png" /><noscript><img width="361" height="224" src="https://www.chennaispinecare.com/wp-content/uploads/2021/07/orthos.png" class="attachment-medium_large size-medium_large" alt="Osteoporotic Spine Fracture surgery" srcset="https://www.chennaispinecare.com/wp-content/uploads/2021/07/orthos.png 361w, https://www.chennaispinecare.com/wp-content/uploads/2021/07/orthos-300x186.png 300w" sizes="(max-width: 361px) 100vw, 361px" /></noscript>
                </div>
				...
				<div class="elementor-element elementor-element-e69627e elementor-widget elementor-widget-text-editor" data-id="e69627e" data-element_type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
								<div class="elementor-text-editor elementor-clearfix">
				<p style="text-align: justify;">Osteoporosis is a major health problem, contributing to 2 million fractures per year. According to the National Osteoporosis Foundation, the number of fractures due to osteoporosis may rise to over 3 million by the year 2025. One in two women and one in four men above 50 years will sustain osteoporotic spine fracture. Many of these have painful fractures of the hip, spine, wrist, arm, and leg, which often occur as a result of a fall. Even simple household tasks can result in fracture of the spine if the bones have been weakened by osteoporosis.</p><ul style="text-align: justify;"><li>Aging &#8211; Everyone loses bone with increase in age. After 35 years of age, the body builds less new bone to replace the lost old bone.</li><li>Heredity</li><li>Nutrition &#8211; Poor nutrition, low calcium diet, and sedentary lifestyle</li><li>Smoking and Excessive Alcohol</li><li>Medications including use of steroids, and to other illnesses, including some thyroid problems</li></ul><p style="text-align: justify;"> </p><p style="text-align: justify;"><strong>Prevention</strong></p><ul style="text-align: justify;"><li>Remove the tumor, or as much of it as possible</li><li>Stabilize the spine</li><li>Reduce pain</li><li>Improve function and quality of life</li></ul><p style="text-align: justify;"><br /><strong>Surgical Procedures are </strong></p><ul style="text-align: justify;"><li>Adequate amounts of calcium and Vitamin D in your diet</li><li>Regular exercises/ physical activity.</li></ul><p style="text-align: justify;"> </p><p style="text-align: justify;">National Academy of Sciences recommendations for daily intake of calcium:</p><p style="text-align: justify;">Males and females 9 to 18 years: 1,300 mg per day</p><ul><li style="text-align: justify;">Women and men 19 to 50 years: 1,000 mg per day</li><li style="text-align: justify;">Pregnant or nursing women up to age 18: 1,300 mg per day</li><li style="text-align: justify;">Pregnant or nursing women 19 to 50 years: 1,000 mg per day</li><li style="text-align: justify;">Women and men over 50: 1,200 mg per day</li></ul>					</div>
						</div>
				</div>
				<div class="elementor-element elementor-element-0d10310 elementor-widget elementor-widget-text-editor" data-id="0d10310" data-element_type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
								<div class="elementor-text-editor elementor-clearfix">
				<p style="text-align: justify;">Treatment of osteoporosis fractures are of 2 parts 1<sup>st</sup> is fracture stabilisation 2<sup>nd</sup> is osteoporosis medical management.</p><p style="text-align: justify;">Two common procedures are done for osteoporotic <a href="https://www.chennaispinecare.com/service/spine-fracture-management/"><strong>spine fracture</strong></a> stabilisation are vertebroplasty and kyphoplasty. In both these procedures cement is injected into the fractured bone through needle to help the fractured spine stable. It&#8217;s done through a stab incision(percutaneous procedures).</p><p style="text-align: justify;">In kyphoplasty, we place a small balloon into the bone and inflates it to raise the spine up. Then we remove the balloon and puts cement into the space left behind.</p>					</div>
						</div>
				</div>
				<div class="elementor-element elementor-element-1b8cd68 doctor_schedule_box ekit-equal-height-disable elementor-widget elementor-widget-elementskit-image-box" data-id="1b8cd68" data-element_type="widget" data-widget_type="elementskit-image-box.default">
				<div class="elementor-widget-container">
			<div class="ekit-wid-con" >
            <div class="elementskit-info-image-box ekit-image-box text-center simple-card" >
                ...
                <div class="elementskit-box-header image-box-img-center">
                    ...
                    <img width="715" height="256" src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20715%20256'%3E%3C/svg%3E" class="attachment-medium_large size-medium_large" alt="Osteoporotic Spine Fracture Management" data-lazy-srcset="https://www.chennaispinecare.com/wp-content/uploads/2021/07/der.png 715w, https://www.chennaispinecare.com/wp-content/uploads/2021/07/der-300x107.png 300w, https://www.chennaispinecare.com/wp-content/uploads/2021/07/der-600x215.png 600w" data-lazy-sizes="(max-width: 715px) 100vw, 715px" data-lazy-src="https://www.chennaispinecare.com/wp-content/uploads/2021/07/der.png" /><noscript><img width="715" height="256" src="https://www.chennaispinecare.com/wp-content/uploads/2021/07/der.png" class="attachment-medium_large size-medium_large" alt="Osteoporotic Spine Fracture Management" srcset="https://www.chennaispinecare.com/wp-content/uploads/2021/07/der.png 715w, https://www.chennaispinecare.com/wp-content/uploads/2021/07/der-300x107.png 300w, https://www.chennaispinecare.com/wp-content/uploads/2021/07/der-600x215.png 600w" sizes="(max-width: 715px) 100vw, 715px" /></noscript>
                </div>
				...
				<div class="elementor-element elementor-element-5cad3ed elementor-widget elementor-widget-text-editor" data-id="5cad3ed" data-element_type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
								<div class="elementor-text-editor elementor-clearfix">
				<p>The goal of  osteoporosis medicines is to help the bones stay as strong as possible.</p><ul><li>Bisphosphonates treat osteoporosis by keeping the body from breaking down bone.</li><li>Teriperatide treat osteoporosis in postmenopausal women and men who are more likely to get severe fractures. It’s a man-made form of the parathyroid hormone  and is the first drug shown to make the body form new bone and increase bone mineral density.</li><li>Denosumab treats osteoporosis by interfering with the body&#8217;s bone-breakdown process.</li></ul>					</div>
						</div>
				</div>
						</div>
					</div>
...
<!-- Cache served by breeze CACHE - Last modified: Wed, 22 Sep 2021 17:05:52 GMT -->
