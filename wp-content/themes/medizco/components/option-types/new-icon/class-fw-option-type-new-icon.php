...
class FW_Option_Type_NewIcon extends FW_Option_Type {
	...
	protected function _enqueue_static( $id, $option, $data ) {
		...
		$uri = MEDIZCO_THEME_URI . '/components/option-types/' . $this->get_type() . '/static';
	...
	protected function _render( $id, $option, $data ) {
		...
		return fw_render_view( MEDIZCO_COMPONENTS . '/option-types/' . $this->get_type() . '/view.php', compact( 'id', 'option', 'data', 'set' ) );
	}
	...
	private function generate_unknown_set( $icon ) {
		return array(
			...
			'container-class'	 => '',
			'groups'			 => array(
				'unknown' => esc_html__( 'Unknown Set', 'medizco' ),
			),
			'icons'				 => array(
	...
	private function get_default_sets() {
		return array(
			'font-awesome' => array( // http://fortawesome.github.io/Font-Awesome/icons
				...
				'groups'			 => array(
					'web-application'	 => esc_html__( 'Web Application Icons', 'medizco' ),
					'hand'				 => esc_html__( 'Hand Icons', 'medizco' ),
					'transportation'	 => esc_html__( 'Transportation Icons', 'medizco' ),
					'gender'			 => esc_html__( 'Gender Icons', 'medizco' ),
					'file-type'			 => esc_html__( 'File Type Icons', 'medizco' ),
					'payment'			 => esc_html__( 'Payment Icons', 'medizco' ),
					'currency'			 => esc_html__( 'Currency Icons', 'medizco' ),
					'text-editor'		 => esc_html__( 'Text Editor Icons', 'medizco' ),
					'directional'		 => esc_html__( 'Directional Icons', 'medizco' ),
					'video-player'		 => esc_html__( 'Video Player Icons', 'medizco' ),
					'brand'				 => esc_html__( 'Brand Icons', 'medizco' ),
					'medical'			 => esc_html__( 'Medical Icons', 'medizco' ),
					'medizco-icons'	 	 => esc_html__( 'Medizco Icons', 'medizco' ),
				),
				'icons'				 => array(
					...
					// Medizco Icons
					'icon icon-strategicservices_icon1' => array('group' => 'medizco-icons'),
					'icon icon-strategicservices_icon3' => array('group' => 'medizco-icons'),
					'icon icon-strategicservices_icon4' => array('group' => 'medizco-icons'),
					'icon icon-strategicservices_icon5' => array('group' => 'medizco-icons'),
					'icon icon-strategicservices_icon6' => array('group' => 'medizco-icons'),
					'icon icon-strategicservices_icon7' => array('group' => 'medizco-icons'),
					'icon icon-strategicservices_icon8' => array('group' => 'medizco-icons'),
					'icon icon-post_icon1' => array('group' => 'medizco-icons'),
					'icon icon-post_icon2' => array('group' => 'medizco-icons'),
					'icon icon-post_icon3' => array('group' => 'medizco-icons'),
					'icon icon-post_icon4' => array('group' => 'medizco-icons'),
					'icon icon-post_icon5' => array('group' => 'medizco-icons'),
					'icon icon-application_icon' => array('group' => 'medizco-icons'),
					'icon icon-opened_positions_icon1' => array('group' => 'medizco-icons'),
					'icon icon-opened_positions_icon2' => array('group' => 'medizco-icons'),
					'icon icon-about_us_icon1' => array('group' => 'medizco-icons'),
					'icon icon-about_us_icon2' => array('group' => 'medizco-icons'),
					'icon icon-about_us_icon3' => array('group' => 'medizco-icons'),
					'icon icon-about_us_icon4' => array('group' => 'medizco-icons'),
					'icon icon-About-2' => array('group' => 'medizco-icons'),
					'icon icon-About-3' => array('group' => 'medizco-icons'),
					'icon icon-About-4' => array('group' => 'medizco-icons'),
					'icon icon-About' => array('group' => 'medizco-icons'),
					'icon icon-Banner_current' => array('group' => 'medizco-icons'),
					'icon icon-Banner_factory-1' => array('group' => 'medizco-icons'),
					'icon icon-Banner_factory' => array('group' => 'medizco-icons'),
					'icon icon-Banner_pumpjack' => array('group' => 'medizco-icons'),
					'icon icon-Funfacts-2' => array('group' => 'medizco-icons'),
					'icon icon-Funfacts-3' => array('group' => 'medizco-icons'),
					'icon icon-Funfacts-4' => array('group' => 'medizco-icons'),
					'icon icon-Funfacts' => array('group' => 'medizco-icons'),
					'icon icon-mobile' => array('group' => 'medizco-icons'),
					'icon icon-laptop' => array('group' => 'medizco-icons'),
					'icon icon-desktop' => array('group' => 'medizco-icons'),
					'icon icon-tablet' => array('group' => 'medizco-icons'),
					'icon icon-phone' => array('group' => 'medizco-icons'),
					'icon icon-document' => array('group' => 'medizco-icons'),
					'icon icon-documents' => array('group' => 'medizco-icons'),
					'icon icon-search' => array('group' => 'medizco-icons'),
					'icon icon-clipboard' => array('group' => 'medizco-icons'),
					'icon icon-newspaper' => array('group' => 'medizco-icons'),
					'icon icon-notebook' => array('group' => 'medizco-icons'),
					'icon icon-book-open' => array('group' => 'medizco-icons'),
					'icon icon-browser' => array('group' => 'medizco-icons'),
					'icon icon-calendar' => array('group' => 'medizco-icons'),
					'icon icon-presentation' => array('group' => 'medizco-icons'),
					'icon icon-picture' => array('group' => 'medizco-icons'),
					'icon icon-pictures' => array('group' => 'medizco-icons'),
					'icon icon-video' => array('group' => 'medizco-icons'),
					'icon icon-camera' => array('group' => 'medizco-icons'),
					'icon icon-printer' => array('group' => 'medizco-icons'),
					'icon icon-toolbox' => array('group' => 'medizco-icons'),
					'icon icon-briefcase' => array('group' => 'medizco-icons'),
					'icon icon-wallet' => array('group' => 'medizco-icons'),
					'icon icon-gift' => array('group' => 'medizco-icons'),
					'icon icon-bargraph' => array('group' => 'medizco-icons'),
					'icon icon-grid' => array('group' => 'medizco-icons'),
					'icon icon-expand' => array('group' => 'medizco-icons'),
					'icon icon-focus' => array('group' => 'medizco-icons'),
					'icon icon-edit' => array('group' => 'medizco-icons'),
					'icon icon-adjustments' => array('group' => 'medizco-icons'),
					'icon icon-ribbon' => array('group' => 'medizco-icons'),
					'icon icon-hourglass' => array('group' => 'medizco-icons'),
					'icon icon-lock' => array('group' => 'medizco-icons'),
					'icon icon-megaphone' => array('group' => 'medizco-icons'),
					'icon icon-shield' => array('group' => 'medizco-icons'),
					'icon icon-trophy' => array('group' => 'medizco-icons'),
					'icon icon-flag' => array('group' => 'medizco-icons'),
					'icon icon-map' => array('group' => 'medizco-icons'),
					'icon icon-puzzle' => array('group' => 'medizco-icons'),
					'icon icon-basket' => array('group' => 'medizco-icons'),
					'icon icon-envelope' => array('group' => 'medizco-icons'),
					'icon icon-streetsign' => array('group' => 'medizco-icons'),
					'icon icon-telescope' => array('group' => 'medizco-icons'),
					'icon icon-gears' => array('group' => 'medizco-icons'),
					'icon icon-key' => array('group' => 'medizco-icons'),
					'icon icon-paperclip' => array('group' => 'medizco-icons'),
					'icon icon-attachment' => array('group' => 'medizco-icons'),
					'icon icon-pricetags' => array('group' => 'medizco-icons'),
					'icon icon-lightbulb' => array('group' => 'medizco-icons'),
					'icon icon-layers' => array('group' => 'medizco-icons'),
					'icon icon-pencil' => array('group' => 'medizco-icons'),
					'icon icon-tools' => array('group' => 'medizco-icons'),
					'icon icon-tools-2' => array('group' => 'medizco-icons'),
					'icon icon-scissors' => array('group' => 'medizco-icons'),
					'icon icon-paintbrush' => array('group' => 'medizco-icons'),
					'icon icon-magnifying-glass' => array('group' => 'medizco-icons'),
					'icon icon-circle-compass' => array('group' => 'medizco-icons'),
					'icon icon-linegraph' => array('group' => 'medizco-icons'),
					'icon icon-mic' => array('group' => 'medizco-icons'),
					'icon icon-strategy' => array('group' => 'medizco-icons'),
					'icon icon-beaker' => array('group' => 'medizco-icons'),
					'icon icon-caution' => array('group' => 'medizco-icons'),
					'icon icon-recycle' => array('group' => 'medizco-icons'),
					'icon icon-anchor' => array('group' => 'medizco-icons'),
					'icon icon-profile-male' => array('group' => 'medizco-icons'),
					'icon icon-profile-female' => array('group' => 'medizco-icons'),
					'icon icon-bike' => array('group' => 'medizco-icons'),
					'icon icon-wine' => array('group' => 'medizco-icons'),
					'icon icon-hotairballoon' => array('group' => 'medizco-icons'),
					'icon icon-globe' => array('group' => 'medizco-icons'),
					'icon icon-genius' => array('group' => 'medizco-icons'),
					'icon icon-map-pin' => array('group' => 'medizco-icons'),
					'icon icon-dial' => array('group' => 'medizco-icons'),
					'icon icon-chat' => array('group' => 'medizco-icons'),
					'icon icon-heart' => array('group' => 'medizco-icons'),
					'icon icon-cloud' => array('group' => 'medizco-icons'),
					'icon icon-upload' => array('group' => 'medizco-icons'),
					'icon icon-download' => array('group' => 'medizco-icons'),
					'icon icon-target' => array('group' => 'medizco-icons'),
					'icon icon-hazardous' => array('group' => 'medizco-icons'),
					'icon icon-piechart' => array('group' => 'medizco-icons'),
					'icon icon-speedometer' => array('group' => 'medizco-icons'),
					'icon icon-global' => array('group' => 'medizco-icons'),
					'icon icon-compass' => array('group' => 'medizco-icons'),
					'icon icon-lifesaver' => array('group' => 'medizco-icons'),
					'icon icon-clock' => array('group' => 'medizco-icons'),
					'icon icon-aperture' => array('group' => 'medizco-icons'),
					'icon icon-quote' => array('group' => 'medizco-icons'),
					'icon icon-scope' => array('group' => 'medizco-icons'),
					'icon icon-alarmclock' => array('group' => 'medizco-icons'),
					'icon icon-refresh' => array('group' => 'medizco-icons'),
					'icon icon-happy' => array('group' => 'medizco-icons'),
					'icon icon-sad' => array('group' => 'medizco-icons'),
					'icon icon-facebook' => array('group' => 'medizco-icons'),
					'icon icon-twitter' => array('group' => 'medizco-icons'),
					'icon icon-googleplus' => array('group' => 'medizco-icons'),
					'icon icon-rss' => array('group' => 'medizco-icons'),
					'icon icon-tumblr' => array('group' => 'medizco-icons'),
					'icon icon-linkedin' => array('group' => 'medizco-icons'),
					'icon icon-dribbble' => array('group' => 'medizco-icons'),
					'icon icon-home' => array('group' => 'medizco-icons'),
					'icon icon-apartment' => array('group' => 'medizco-icons'),
					'icon icon-pencil1' => array('group' => 'medizco-icons'),
					'icon icon-magic-wand' => array('group' => 'medizco-icons'),
					'icon icon-drop' => array('group' => 'medizco-icons'),
					'icon icon-lighter' => array('group' => 'medizco-icons'),
					'icon icon-poop' => array('group' => 'medizco-icons'),
					'icon icon-sun' => array('group' => 'medizco-icons'),
					'icon icon-moon' => array('group' => 'medizco-icons'),
					'icon icon-cloud1' => array('group' => 'medizco-icons'),
					'icon icon-cloud-upload' => array('group' => 'medizco-icons'),
					'icon icon-cloud-download' => array('group' => 'medizco-icons'),
					'icon icon-cloud-sync' => array('group' => 'medizco-icons'),
					'icon icon-cloud-check' => array('group' => 'medizco-icons'),
					'icon icon-database' => array('group' => 'medizco-icons'),
					'icon icon-lock1' => array('group' => 'medizco-icons'),
					'icon icon-cog' => array('group' => 'medizco-icons'),
					'icon icon-trash' => array('group' => 'medizco-icons'),
					'icon icon-dice' => array('group' => 'medizco-icons'),
					'icon icon-heart1' => array('group' => 'medizco-icons'),
					'icon icon-star' => array('group' => 'medizco-icons'),
					'icon icon-star-half' => array('group' => 'medizco-icons'),
					'icon icon-star-empty' => array('group' => 'medizco-icons'),
					'icon icon-flag1' => array('group' => 'medizco-icons'),
					'icon icon-envelope1' => array('group' => 'medizco-icons'),
					'icon icon-paperclip1' => array('group' => 'medizco-icons'),
					'icon icon-inbox' => array('group' => 'medizco-icons'),
					'icon icon-eye' => array('group' => 'medizco-icons'),
					'icon icon-printer1' => array('group' => 'medizco-icons'),
					'icon icon-file-empty' => array('group' => 'medizco-icons'),
					'icon icon-file-add' => array('group' => 'medizco-icons'),
					'icon icon-enter' => array('group' => 'medizco-icons'),
					'icon icon-exit' => array('group' => 'medizco-icons'),
					'icon icon-graduation-hat' => array('group' => 'medizco-icons'),
					'icon icon-license' => array('group' => 'medizco-icons'),
					'icon icon-music-note' => array('group' => 'medizco-icons'),
					'icon icon-film-play' => array('group' => 'medizco-icons'),
					'icon icon-camera-video' => array('group' => 'medizco-icons'),
					'icon icon-camera1' => array('group' => 'medizco-icons'),
					'icon icon-picture1' => array('group' => 'medizco-icons'),
					'icon icon-book' => array('group' => 'medizco-icons'),
					'icon icon-bookmark' => array('group' => 'medizco-icons'),
					'icon icon-user' => array('group' => 'medizco-icons'),
					'icon icon-users' => array('group' => 'medizco-icons'),
					'icon icon-shirt' => array('group' => 'medizco-icons'),
					'icon icon-store' => array('group' => 'medizco-icons'),
					'icon icon-cart' => array('group' => 'medizco-icons'),
					'icon icon-tag' => array('group' => 'medizco-icons'),
					'icon icon-phone-handset' => array('group' => 'medizco-icons'),
					'icon icon-phone1' => array('group' => 'medizco-icons'),
					'icon icon-pushpin' => array('group' => 'medizco-icons'),
					'icon icon-map-marker' => array('group' => 'medizco-icons'),
					'icon icon-map1' => array('group' => 'medizco-icons'),
					'icon icon-location' => array('group' => 'medizco-icons'),
					'icon icon-calendar-full' => array('group' => 'medizco-icons'),
					'icon icon-keyboard' => array('group' => 'medizco-icons'),
					'icon icon-spell-check' => array('group' => 'medizco-icons'),
					'icon icon-screen' => array('group' => 'medizco-icons'),
					'icon icon-smartphone' => array('group' => 'medizco-icons'),
					'icon icon-tablet1' => array('group' => 'medizco-icons'),
					'icon icon-laptop1' => array('group' => 'medizco-icons'),
					'icon icon-laptop-phone' => array('group' => 'medizco-icons'),
					'icon icon-power-switch' => array('group' => 'medizco-icons'),
					'icon icon-bubble' => array('group' => 'medizco-icons'),
					'icon icon-heart-pulse' => array('group' => 'medizco-icons'),
					'icon icon-construction' => array('group' => 'medizco-icons'),
					'icon icon-pie-chart' => array('group' => 'medizco-icons'),
					'icon icon-chart-bars' => array('group' => 'medizco-icons'),
					'icon icon-gift1' => array('group' => 'medizco-icons'),
					'icon icon-diamond' => array('group' => 'medizco-icons'),
					'icon icon-dinner' => array('group' => 'medizco-icons'),
					'icon icon-coffee-cup' => array('group' => 'medizco-icons'),
					'icon icon-leaf' => array('group' => 'medizco-icons'),
					'icon icon-paw' => array('group' => 'medizco-icons'),
					'icon icon-rocket' => array('group' => 'medizco-icons'),
					'icon icon-briefcase1' => array('group' => 'medizco-icons'),
					'icon icon-bus' => array('group' => 'medizco-icons'),
					'icon icon-car' => array('group' => 'medizco-icons'),
					'icon icon-train' => array('group' => 'medizco-icons'),
					'icon icon-bicycle' => array('group' => 'medizco-icons'),
					'icon icon-wheelchair' => array('group' => 'medizco-icons'),
					'icon icon-select' => array('group' => 'medizco-icons'),
					'icon icon-earth' => array('group' => 'medizco-icons'),
					'icon icon-smile' => array('group' => 'medizco-icons'),
					'icon icon-sad1' => array('group' => 'medizco-icons'),
					'icon icon-neutral' => array('group' => 'medizco-icons'),
					'icon icon-mustache' => array('group' => 'medizco-icons'),
					'icon icon-alarm' => array('group' => 'medizco-icons'),
					'icon icon-bullhorn' => array('group' => 'medizco-icons'),
					'icon icon-volume-high' => array('group' => 'medizco-icons'),
					'icon icon-volume-medium' => array('group' => 'medizco-icons'),
					'icon icon-volume-low' => array('group' => 'medizco-icons'),
					'icon icon-volume' => array('group' => 'medizco-icons'),
					'icon icon-mic1' => array('group' => 'medizco-icons'),
					'icon icon-hourglass1' => array('group' => 'medizco-icons'),
					'icon icon-undo' => array('group' => 'medizco-icons'),
					'icon icon-redo' => array('group' => 'medizco-icons'),
					'icon icon-sync' => array('group' => 'medizco-icons'),
					'icon icon-history' => array('group' => 'medizco-icons'),
					'icon icon-clock1' => array('group' => 'medizco-icons'),
					'icon icon-download1' => array('group' => 'medizco-icons'),
					'icon icon-upload1' => array('group' => 'medizco-icons'),
					'icon icon-enter-down' => array('group' => 'medizco-icons'),
					'icon icon-exit-up' => array('group' => 'medizco-icons'),
					'icon icon-bug' => array('group' => 'medizco-icons'),
					'icon icon-code' => array('group' => 'medizco-icons'),
					'icon icon-link' => array('group' => 'medizco-icons'),
					'icon icon-unlink' => array('group' => 'medizco-icons'),
					'icon icon-thumbs-up' => array('group' => 'medizco-icons'),
					'icon icon-thumbs-down' => array('group' => 'medizco-icons'),
					'icon icon-magnifier' => array('group' => 'medizco-icons'),
					'icon icon-cross' => array('group' => 'medizco-icons'),
					'icon icon-menu' => array('group' => 'medizco-icons'),
					'icon icon-list' => array('group' => 'medizco-icons'),
					'icon icon-chevron-up' => array('group' => 'medizco-icons'),
					'icon icon-chevron-down' => array('group' => 'medizco-icons'),
					'icon icon-chevron-left' => array('group' => 'medizco-icons'),
					'icon icon-chevron-right' => array('group' => 'medizco-icons'),
					'icon icon-arrow-up' => array('group' => 'medizco-icons'),
					'icon icon-arrow-down' => array('group' => 'medizco-icons'),
					'icon icon-arrow-left' => array('group' => 'medizco-icons'),
					'icon icon-arrow-right' => array('group' => 'medizco-icons'),
					'icon icon-move' => array('group' => 'medizco-icons'),
					'icon icon-warning' => array('group' => 'medizco-icons'),
					'icon icon-question-circle' => array('group' => 'medizco-icons'),
					'icon icon-menu-circle' => array('group' => 'medizco-icons'),
					'icon icon-checkmark-circle' => array('group' => 'medizco-icons'),
					'icon icon-cross-circle' => array('group' => 'medizco-icons'),
					'icon icon-plus-circle' => array('group' => 'medizco-icons'),
					'icon icon-circle-minus' => array('group' => 'medizco-icons'),
					'icon icon-arrow-up-circle' => array('group' => 'medizco-icons'),
					'icon icon-arrow-down-circle' => array('group' => 'medizco-icons'),
					'icon icon-arrow-left-circle' => array('group' => 'medizco-icons'),
					'icon icon-arrow-right-circle' => array('group' => 'medizco-icons'),
					'icon icon-chevron-up-circle' => array('group' => 'medizco-icons'),
					'icon icon-chevron-down-circle' => array('group' => 'medizco-icons'),
					'icon icon-chevron-left-circle' => array('group' => 'medizco-icons'),
					'icon icon-chevron-right-circle' => array('group' => 'medizco-icons'),
					'icon icon-crop' => array('group' => 'medizco-icons'),
					'icon icon-frame-expand' => array('group' => 'medizco-icons'),
					'icon icon-frame-contract' => array('group' => 'medizco-icons'),
					'icon icon-layers1' => array('group' => 'medizco-icons'),
					'icon icon-funnel' => array('group' => 'medizco-icons'),
					'icon icon-text-format' => array('group' => 'medizco-icons'),
					'icon icon-text-size' => array('group' => 'medizco-icons'),
					'icon icon-bold' => array('group' => 'medizco-icons'),
					'icon icon-italic' => array('group' => 'medizco-icons'),
					'icon icon-underline' => array('group' => 'medizco-icons'),
					'icon icon-strikethrough' => array('group' => 'medizco-icons'),
					'icon icon-highlight' => array('group' => 'medizco-icons'),
					'icon icon-text-align-left' => array('group' => 'medizco-icons'),
					'icon icon-text-align-center' => array('group' => 'medizco-icons'),
					'icon icon-text-align-right' => array('group' => 'medizco-icons'),
					'icon icon-text-align-justify' => array('group' => 'medizco-icons'),
					'icon icon-line-spacing' => array('group' => 'medizco-icons'),
					'icon icon-indent-increase' => array('group' => 'medizco-icons'),
					'icon icon-indent-decrease' => array('group' => 'medizco-icons'),
					'icon icon-page-break' => array('group' => 'medizco-icons'),
					'icon icon-hand' => array('group' => 'medizco-icons'),
					'icon icon-pointer-up' => array('group' => 'medizco-icons'),
					'icon icon-pointer-right' => array('group' => 'medizco-icons'),
					'icon icon-pointer-down' => array('group' => 'medizco-icons'),
					'icon icon-pointer-left' => array('group' => 'medizco-icons'),
					'icon icon-vplay' => array('group' => 'medizco-icons'),
					'icon icon-newsletter' => array('group' => 'medizco-icons'),
					'icon icon-coins-2' => array('group' => 'medizco-icons'),
					'icon icon-commerce-2' => array('group' => 'medizco-icons'),
					'icon icon-monitor' => array('group' => 'medizco-icons'),
					'icon icon-graphic-3' => array('group' => 'medizco-icons'),
					'icon icon-business' => array('group' => 'medizco-icons'),
					'icon icon-graphic-2' => array('group' => 'medizco-icons'),
					'icon icon-commerce-1' => array('group' => 'medizco-icons'),
					'icon icon-hammer' => array('group' => 'medizco-icons'),
					'icon icon-graphic-1' => array('group' => 'medizco-icons'),
					'icon icon-graphic' => array('group' => 'medizco-icons'),
					'icon icon-justice-1' => array('group' => 'medizco-icons'),
					'icon icon-line' => array('group' => 'medizco-icons'),
					'icon icon-money-3' => array('group' => 'medizco-icons'),
					'icon icon-chart' => array('group' => 'medizco-icons'),
					'icon icon-commerce' => array('group' => 'medizco-icons'),
					'icon icon-agenda' => array('group' => 'medizco-icons'),
					'icon icon-money-2' => array('group' => 'medizco-icons'),
					'icon icon-justice' => array('group' => 'medizco-icons'),
					'icon icon-money-1' => array('group' => 'medizco-icons'),
					'icon icon-money' => array('group' => 'medizco-icons'),
					'icon icon-technology' => array('group' => 'medizco-icons'),
					'icon icon-coins-1' => array('group' => 'medizco-icons'),
					'icon icon-coins' => array('group' => 'medizco-icons'),
					'icon icon-left-arrow' => array('group' => 'medizco-icons'),
					'icon icon-bank' => array('group' => 'medizco-icons'),
					'icon icon-calculator' => array('group' => 'medizco-icons'),
					'icon icon-chart1' => array('group' => 'medizco-icons'),
					'icon icon-chart2' => array('group' => 'medizco-icons'),
					'icon icon-checked' => array('group' => 'medizco-icons'),
					'icon icon-clock2' => array('group' => 'medizco-icons'),
					'icon icon-comment' => array('group' => 'medizco-icons'),
					'icon icon-comments' => array('group' => 'medizco-icons'),
					'icon icon-consult' => array('group' => 'medizco-icons'),
					'icon icon-consut2' => array('group' => 'medizco-icons'),
					'icon icon-deal' => array('group' => 'medizco-icons'),
					'icon icon-download2' => array('group' => 'medizco-icons'),
					'icon icon-envelope2' => array('group' => 'medizco-icons'),
					'icon icon-euro' => array('group' => 'medizco-icons'),
					'icon icon-folder' => array('group' => 'medizco-icons'),
					'icon icon-invest' => array('group' => 'medizco-icons'),
					'icon icon-loan' => array('group' => 'medizco-icons'),
					'icon icon-map-marker1' => array('group' => 'medizco-icons'),
					'icon icon-mutual-fund' => array('group' => 'medizco-icons'),
					'icon icon-percent' => array('group' => 'medizco-icons'),
					'icon icon-phone2' => array('group' => 'medizco-icons'),
					'icon icon-pie-chart1' => array('group' => 'medizco-icons'),
					'icon icon-play' => array('group' => 'medizco-icons'),
					'icon icon-left-arrow2' => array('group' => 'medizco-icons'),
					'icon icon-savings' => array('group' => 'medizco-icons'),
					'icon icon-search1' => array('group' => 'medizco-icons'),
					'icon icon-tag1' => array('group' => 'medizco-icons'),
					'icon icon-tags' => array('group' => 'medizco-icons'),
					'icon icon-tax' => array('group' => 'medizco-icons'),
					'icon icon-quote1' => array('group' => 'medizco-icons'),
					'icon icon-right-arrow2' => array('group' => 'medizco-icons'),
