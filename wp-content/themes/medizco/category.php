<?php
/**
 * the template for displaying archive pages. indiqaanalytics.com . easyseocheck.com . northeastwebdesigner.com
 */

   get_header(); 
   get_template_part( 'template-parts/banner/content', 'banner-catagory' );
